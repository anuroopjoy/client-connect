...
import { ISettings, RenderDimensionValue } from '../interfaces/settings.interface';
import { RenderDimensions } from '../constants/settings.constants';

export default function generateConnectionOptions(settings: ISettings) {
